...
const QuizApp = () => {
  ...
  const questions = [
    ...
    {
      id: 2,
      questionText: 'ما هي العقوبة في حال قام الموظف بتسريب بيانات للوزارة على وسائل التواصل الاجتماعي؟',
      options: [
        'تنبيه ولفت نظر فقط',
        'لا توجد أي عقوبة',
    ...
    {
      id: 3,
      questionText: 'يمكن أن تكون مشاركة الملفات على الأجهزة الشخصية باستخدام التطبيقات الغير آمنة محفوفة بالمخاطر لأن:',
      options: [
        'الأجهزة الشخصية لا تحتوي على الوصول إلى الإنترنت',
        'قد تفتقر إلى تدابير الأمان المناسبة',
        'عادة ما تكون أبطأ',
        'تخلق مزيدًا من المحادثات الجماعية'
      ],
      correctAnswer: 1
    },
    {
      id: 4,
      questionText: 'ما المخاطر المترتبة على استخدام التطبيقات غير الآمنة لمشاركة الملفات؟',
      options: [
        'خروقات البيانات',
      ...
      <div className="w-full max-w-2xl mx-auto">
        {!showScore ? (
          ...
          >
            ...
            <p className="text-gray-600 mb-6">حصلت على {score} من أصل 10 نقاط</p>
